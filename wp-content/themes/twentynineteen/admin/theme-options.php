<?php
	...
	function portfolio__create_tabs( $current = 'general' )
	{
...
/* ============================================================================================================================================ */
	...
	function portfolio__theme_options_page()
	{
		global $pagenow;
		...
		?>
			<div class="wrap wrap2">
				...
				<?php
					...
					if ( isset( $_GET['tab'] ) )
					{
						portfolio__create_tabs( $_GET['tab'] );
					}	
					else
					{
						portfolio__create_tabs( 'general' );
					}
													...
													<table>
														...
														<tr>
															<td class="option-left">
																...
																<select id="portfolio__ajax" name="portfolio__ajax">
																	<option>Yes</option>
																	
																	<option <?php if ( $portfolio__ajax == 'No' ) { echo 'selected="selected"'; } ?>>No</option>
																</select>
															</td>
													...
													<table>
														...
														<tr>
															<td class="option-left">
																...
																<?php
																	$portfolio__related_posts = get_option( 'portfolio__related_posts', 'Yes' );
																?>
																
																<select id="portfolio__related_posts" name="portfolio__related_posts">
																	<option>Yes</option>
																	
																	<option <?php if ( $portfolio__related_posts == 'No' ) { echo 'selected="selected"'; } ?>>No</option>
																</select>
															</td>
														...
														<tr>
															<td class="option-left">
																<h4>Back To Blog</h4>
																<?php
																	$portfolio__back_to_blog_link_behaviour = get_option( 'portfolio__back_to_blog_link_behaviour', 'to_regular_blog' );
																?>
																<select name="portfolio__back_to_blog_link_behaviour">
																	<option>To Regular Blog</option>
																	<option <?php if ( $portfolio__back_to_blog_link_behaviour == 'to_grid_blog' ) { echo 'selected="selected"'; } ?> value="to_grid_blog">To Grid Blog</option>
																</select>
															</td>
...
/* ============================================================================================================================================ */
	...
	function portfolio__theme_save_settings()
	{
		global $pagenow;
		...
		if ( $pagenow == 'themes.php' && $_GET['page'] == 'theme-options' )
		{
			...
			switch ( $tab )
			{
				...
				case 'layout' :
					...
					update_option( 'portfolio__ajax', $_POST['portfolio__ajax'] );
				...
				case 'blog' :
					...
					update_option( 'portfolio__related_posts', $_POST['portfolio__related_posts'] );
					update_option( 'pagination', $_POST['pagination'] );
					update_option( 'portfolio__back_to_blog_link_behaviour', $_POST['portfolio__back_to_blog_link_behaviour'] );
...
/* ============================================================================================================================================ */
	...
	function portfolio__load_settings_page()
	{
		if ( isset( $_POST["settings-submit"] ) == 'Y' )
		{
			check_admin_referer( "settings-page" );
			
			portfolio__theme_save_settings();
...
/* ============================================================================================================================================ */
	...
	function portfolio__theme_menu()
	{
		$settings_page = add_theme_page('Theme Options',
										'Theme Options',
										'edit_theme_options',
										'theme-options',
										'portfolio__theme_options_page' );
		
		add_action( "load-{$settings_page}", 'portfolio__load_settings_page' );
	}
	
	add_action( 'admin_menu', 'portfolio__theme_menu' );
